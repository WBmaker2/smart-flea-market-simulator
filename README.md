...
- GitHub Pages: https://wbmaker2.github.io/smart-flea-market-simulator/
...
- 학습 미션 카드(필수 물건 2개 이상, 3,000원 이상 남기기, 선택 물건 1개 이하) 실시간 달성 확인
- 장바구니 반응/경고 상태를 `role="status"`, `role="alert"`로 공지하여 화면 읽기 접근성 반응 확인 가능

## 수업 패키지

- [학생 활동지](./docs/classroom/student-activity-sheet.md)
- [교사용 수업안](./docs/classroom/teacher-guide.md)

앱에는 출력 가능한 **학생 활동지**, 선택 이유를 문장으로 정리하는 **발표 카드**, 그리고 수업 운영 지침이 들어 있는 **교사용 수업안**이 포함되어 있습니다.
...
- 선택 결과가 예산을 넘으면 장바구니에 들어가지 않고 경고가 보입니다.
- 미션 카드가 장바구니 상태에 따라 `도전 중`과 `달성`으로 바뀝니다.
